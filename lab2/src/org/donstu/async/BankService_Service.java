 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "https://donstu.org/bank", wsdlLocation = "http://127.0.0.1:8088/bank-service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("https://donstu.org/bank", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8088/bank-service?wsdl");
    ...
    public BankService getBankPort() {
        return super.getPort(new QName("https://donstu.org/bank", "BankPort"), BankService.class);
    }
    ...
    public BankService getBankPort(WebServiceFeature... features) {
        return super.getPort(new QName("https://donstu.org/bank", "BankPort"), BankService.class, features);
    }
